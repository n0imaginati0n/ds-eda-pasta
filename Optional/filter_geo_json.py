...
def get_filtered_json(json_file_name: str, zipcode: list, force: bool = False):
    ...
    if force or not os.path.isfile(json_file_name):
        with urllib.request.urlopen(url) as url_request:
            geodata = json.load(url_request)
            ...
            write_result_json(json_file_name, geodata)
